    ...
    <section id="objective" className="w-full py-20 md:py-32 lg:py-40 px-4 md:px-6 lg:px-12 bg-deep-green relative overflow-hidden arc-t">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="absolute top-0 bottom-0 right-8 md:right-1/2 w-[1px] transform md:translate-x-1/2 z-20">
            <motion.div 
            ...
            {objectives.map((obj, index) => {
              ...
              return (
                <div key={obj.id} className={clsx(
                  "flex flex-col md:flex-row items-center w-full relative py-8 md:py-16",
                  ...
                  <motion.div 
                    className={clsx(
                      "w-full md:w-1/2 flex relative z-10",
                      "pr-20 md:pr-0 md:px-12 lg:px-24",
                  ...
                  >
                    <div className={clsx(
                      "relative p-8 md:p-10 w-full max-w-md border",
                      obj.isSpecial 
                  ...
                  {/* Center Node (Desktop) */}
                  <div className="absolute right-1/2 translate-x-1/2 z-30 hidden md:flex items-center justify-center">
                    <motion.div 
                  ...
                  {/* Mobile Node */}
                  <div className="absolute right-8 translate-x-1/2 z-30 md:hidden flex items-center justify-center">
                    <motion.div 
                      initial={{ opacity: 0, scale: 0 }}
                      whileInView={{ opacity: 1, scale: 1 }}
                      viewport={{ once: true }}
